		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Tambah Guru Mapel</h3>
				</div>
				<div class="card-body">
					<?php echo form_open('guru_mapel/add',array("class"=>"form-horizontal")); ?>

					<div class="form-group">
						<label for="id_guru" class="col-md-4 control-label"><span
            ...
            ?>
					...
					<div class="form-group">
						<label for="id_mapel" class="col-md-4 control-label"><span
								class="text-danger">*</span>Mapel</label>
						<div class="col-md-8">
